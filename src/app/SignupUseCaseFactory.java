...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
            ...
            ClearViewModel clearViewModel, FileUserDataAccessObject userDataAccessObject) {
    ...
    private static ClearController createClearUseCase(ClearViewModel clearViewModel, ClearUserDataAccessInterface clearUserDataAccessInterface) {
